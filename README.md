...
This holds when the classifier is trained from scratch. 
With an ImageNet backbone the effect disappears entirely — see [Where the effect disappears](#where-the-effect-disappears).
